            ...
            <div
               ...
               top-[50%] left-[50%] translate-x-[-50%]  translate-y-[-50%]  ">
                ...
                <div
                    ...
                    className="  Main-Color   flex  flex-col items-center      md:items-start     w-[100%] md:w-[45%]  lg:w-[55%] " >
                    <h1
                        className=" font-bold text-[l.1rem]  md:text-[1.3rem]  lg:text-[1.9rem] capitalize   relative  "
                    >
                        <span className="Sub-Title-Hero  md:text-[0.9rem] text-[1.01rem] ">{Lang?.PAGE_HOME?.lANDING?.SUB_TITLE}</span>
                    ...
                    <button className={`Main-Btn Second-Color w-fit  flex items-center my-[0.8rem]  md:my-[1rem] lg:my-[1.2rem] ${DirButton}`}>
                        <span >
                            {Lang?.PAGE_HOME?.lANDING?.TEXT_BUTTON}
                        </span>
                        {
                            Rtl ? <FaArrowLeft className={`${DirButtonIcon} `} /> : <FaArrowRight className={`${DirButtonIcon}`} />
                        }
                    </button>
                    ...
                    <div className="  Box-One  relative ">
                        ...
                        <div className=" overflow-hidden  relative   top-[-2.8rem] md:top-[-1.8rem] Bg-Second Rounded-6    h-[75%]    ">
                            ...
                            >
                                ...
                                <h4 className=" font-bold    text-[0.9rem]  ">{Lang?.PAGE_HOME?.lANDING?.CARD_1?.TITLE} </h4>
                                <h6 className="   text-[0.9rem]  ">{Lang?.PAGE_HOME?.lANDING?.CARD_1?.DES}.</h6>
                        ...
                        <div className=" absolute bottom-0 left-0 w-full    Bg-light  Rounded-6 px-[0.5rem] py-[0.7rem]">
                            <div className=" flex  justify-center gap-x-[2px] ">
                                ...
                                <div className="Avatar  Flex-Center">
                                    <img src="/Img/lang_1.png" className=" rounded-[50%] object-cover w-full h-[100%]" alt=" Avatar" />
                                </div>
                                <div className="Avatar Flex-Center">
                                    <img src="/Img/lang_1.png" className=" rounded-[50%] object-cover w-full h-[100%]" alt=" Avatar" />
                                </div>
                            ...
                            <p className="  text-sm Flex-Center Second-Color pt-[0.2rem]  "> {Lang?.CUSTOMER_REVIEWS}</p>
                        </div>
                    </div>
                    ...
                    <div className="  Box-Two  relative flex justify-end  flex-col  ">
                        <div
                            ...
                            <div className=" font-bold ">
                                <h2 className="Active-Color   text-[1rem] md:text-[1.2rem] lg:text-[1.4rem]">    547 +</h2>
                        ...
                        <div className={`     sm:basis-[75%]    overflow-hidden   Bg-Second Rounded-6    relative `}>
                            ...
                            <div className=" text-center md:text-left  
                              absolute  Bg-light  p-[0.5rem] bottom-[0px] m-[0.6rem] 
                                 Second-Color   Rounded-6    "
                            >
                                <h4 className=" font-bold  text-sm ">{Lang?.PAGE_HOME?.lANDING?.CARD_2?.TITLE} </h4>
                                <h6 className="  text-[0.9rem]  ">{Lang?.PAGE_HOME?.lANDING?.CARD_2?.DES}.</h6>
